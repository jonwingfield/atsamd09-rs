...
#[cfg(feature = "samd10")]
use target_device::SERCOM2;
use target_device::{SERCOM0, SERCOM1, PM};
use time::Hertz;
...
#[cfg(feature = "samd10")]
spi_pinout!([SPI2Pinout: (Sercom2Pad0, Sercom2Pad1, Sercom2Pad2, Sercom2Pad3),]);
...
#[cfg(feature = "samd10")]
spi!([SPIMaster2: (SPI2Pinout, SERCOM2, sercom2_, Sercom2CoreClock),]);
